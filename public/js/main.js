...
// Get te products list and elemenst
...
function renderProducts(){
    ...
    .map((product)=>`<div class="product">
                ...
                <div class="product-info">
                    ...
                    <a class="add-to-cart" data-id="${product.id}">Add to cart-data</a>
                </div>
            </div>
    `
).join("");
    ...
    .map((item)=>`
        <div class="cart-item">
                        ...
                        <div class="cart-item-info">
                            ...
                            <input type="number" name="" id="" class="cart-item-quantity" min="1" value="${item.quantity}" data-id="${item.id}">
...
// Empty Cart On Sucessfull Payment
function clearCart()
{
    cart =[];
    saveToLocalStorage();
